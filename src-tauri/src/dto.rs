...
pub struct SettingsDto {
    ...
    pub tracex_tui_path                    : Option<String>,
...
impl From<&Settings> for SettingsDto {
    fn from(settings: &Settings) -> Self {
        Self {
            ...
            tracex_use_tui                     : settings.tracex_use_tui,
            ...
            auto_run_loader_on_valorant        : settings.auto_run_loader_on_valorant,
...
impl From<SettingsDto> for Settings {
    fn from(dto: SettingsDto) -> Self {
        Self {
            ...
            tracex_tui_path                    : dto.tracex_tui_path.map(PathBuf::from),
            tracex_use_tui                     : dto.tracex_use_tui,
            ...
            auto_run_loader_on_valorant        : dto.auto_run_loader_on_valorant,
