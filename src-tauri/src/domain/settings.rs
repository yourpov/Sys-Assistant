...
impl Default for Settings {
    fn default() -> Self {
        Self {
            ...
            sesh_watchdog_enabled          : false,
            anti_temp_ban_enabled          : false,
            install_emu_on_riot_launch_enabled : false,
            auto_fix_55_enabled                : false,
            toast_os_notifications_enabled : false,
            confirm_before_actions_enabled : false,
            hide_account_usernames         : false,
